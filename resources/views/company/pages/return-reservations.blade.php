...
@section('title', 'T-Car — Return Reservations')

@section('content')
<div class="page-header">
            <div>
              <h1 class="page-header__title">{{ __('company.pages.return-reservations.0') }}</h1>
              <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
                <a href="{{ route('company.dashboard') }}">{{ __('company.common.176') }}</a>
                <i class="bi bi-chevron-right"></i>
                <span>{{ __('company.common.167') }}</span>
                <i class="bi bi-chevron-right"></i>
                <span class="current"> {{ __('company.pages.return-reservations.0') }}</span>
              </nav>
            </div>
              ...
              <table class="data-table" id="returnTable">
                <thead>
                  <tr>
                    ...
                    <th>{{ __('company.pages.return-reservations.1') }}</th>
...
<script>
      ...
      var closeReservationSuccessModalEl = document.getElementById('closeReservationSuccessModal');
      ...
      document.getElementById('confirmCloseReservationBtn').addEventListener('click', function () {
