...
@section('title', 'T-Car — تعديل مدير شركة')

@section('content')

          <div class="page-header">
            <div>
              <h1 class="page-header__title">{{ __('company.pages.edit-company-manager.0') }}</h1>
              <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
                ...
                <i class="bi bi-chevron-right"></i>
                <span class="current">{{ __('company.pages.edit-company-manager.0') }}</span>
              </nav>
            </div>
          </div>
            ...
            <div class="edit-office-card mb-4">
              <div class="edit-office-card__header">
                <h5 class="edit-office-card__title">
                  <i class="bi bi-person-plus"></i> {{ __('company.pages.edit-company-manager.1') }}</h5>
              </div>
                    ...
                    <div class="dropdown user-branches-dropdown" data-branches-dropdown>
                      ...
                      <div class="dropdown-menu user-branches-menu w-100">
                        <label class="user-branch-option">
                          <input type="checkbox" value="branch1" checked />
                    ...
                    <div class="phone-input-group">
                      <div class="phone-input-group__code">
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" data-code="966">+966</a></li>
                            <li><a class="dropdown-item" href="#" data-code="971">+971</a></li>
                            <li><a class="dropdown-item" href="#" data-code="20">+20</a></li>
                            <li><a class="dropdown-item" href="#" data-code="965">+965</a></li>
                            <li><a class="dropdown-item" href="#" data-code="974">+974</a></li>
                          </ul>
                        </div>
                      </div>
                      <input
                    ...
                    <div class="phone-input-group">
                      <div class="phone-input-group__code">
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" data-code="">{{ __('company.common.105') }}</a></li>
                            <li><a class="dropdown-item" href="#" data-code="966">+966</a></li>
                            <li><a class="dropdown-item" href="#" data-code="971">+971</a></li>
                            <li><a class="dropdown-item" href="#" data-code="20">+20</a></li>
                            <li><a class="dropdown-item" href="#" data-code="965">+965</a></li>
