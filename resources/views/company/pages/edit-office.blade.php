...
@section('title', 'T-Car — تعديل تفاصيل الفرع')
          ...
          <div class="page-header">
            <div>
              ...
              <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
                ...
                <i class="bi bi-chevron-right"></i>
                <span class="current">{{ __('company.pages.edit-office.0') }}</span>
              </nav>
            </div>
          </div>
          ...
          <form id="editOfficeForm">
                  ...
                  <div class="col-md-6">
                    <div class="form-field">
                      ...
                      <input
                        ...
                        value="N2 فرع العقيق"
                         placeholder="{{ __('company.common.53') }}"
                      />
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-field">
                      ...
                      <input
                        type="text"
                        class="form-field__input"
                        value="fares.alhattar@example.com"
                         placeholder="{{ __('company.common.58') }}"
                      />
                    </div>
                  </div>
                  <div class="col-md-6">
            ...
            <div class="edit-office-card" id="sec-location">
              ...
              <div class="edit-office-card__body">
                ...
                <input type="hidden" id="officeLat" name="office_lat" value="24.78" />
                <input type="hidden" id="officeLng" name="office_lng" value="46.68" />
                  ...
                  <div class="service-action" id="deliveryOnlyServiceAction">
                    <div class="distance-pricing-table" id="distancePricingTable">
                      ...
                      <div class="distance-pricing-row">
                        <input type="text" class="form-field__input ltr-num" value="2" />
                        <input type="text" class="form-field__input ltr-num" value="15" />
                      </div>
                      <div class="distance-pricing-row">
                        <input type="text" class="form-field__input ltr-num" value="5" />
                        <input type="text" class="form-field__input ltr-num" value="20" />
                      </div>
                      <div class="distance-pricing-row">
                        <input type="text" class="form-field__input ltr-num" value="7" />
                        <input type="text" class="form-field__input ltr-num" value="30" />
                      </div>
                      <div class="distance-pricing-row">
                        <input type="text" class="form-field__input ltr-num" value="10" />
                      ...
                      <div class="distance-pricing-row">
                        <input type="text" class="form-field__input ltr-num" value="20" />
                        <input type="text" class="form-field__input ltr-num" value="70" />
                      </div>
                    </div>
...
<script>
      ...
      ============================================================= */
        ...
        function wireDeleteRow(row) {
          var deleteButton = row.querySelector('.distance-pricing-row__delete');
        ...
        var addDistanceRowBtn = document.getElementById('addDistanceRowBtn');
        if (addDistanceRowBtn)
          addDistanceRowBtn.addEventListener('click', function () {
            var row = document.createElement('div');
            row.className = 'distance-pricing-row';
            row.innerHTML =
              '<input type="text" class="form-field__input ltr-num" placeholder="0">' +
              '<input type="text" class="form-field__input ltr-num" placeholder="0">' +
              '<input type="text" class="form-field__input ltr-num" placeholder="60">' +
