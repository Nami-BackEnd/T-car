...
@section('title', 'T-Car — تعديل تفاصيل السيارة')

@section('content')

          <div class="page-header">
            <div>
              <h1 class="page-header__title">{{ __('company.pages.edit-car.0') }}</h1>
                ...
                <div class="form-grid">
                  ...
                  <div class="form-field car-image-field">
                    ...
                    <div
                      ...
                      data-car-image-key="car-edit-current"
                    >
                      <div class="car-image-uploader__preview-wrap">
                        <img
                          ...
                          src="{{ asset('company/img/car.png') }}"
                           alt="{{ __('company.pages.edit-car.5') }}"
                        />
                      ...
                      <div class="car-image-uploader__content">
                        <p class="car-image-uploader__title">{{ __('company.pages.edit-car.1') }}</p>
                        <p class="car-image-uploader__hint">{{ __('company.pages.edit-car.2') }}</p>
                      </div>
                      <input
                        id="carImageInput"
                        type="file"
